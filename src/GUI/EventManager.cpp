...
#include <iostream>
EventManager::EventManager() : m_currentState(), m_hasFocus(true) { LoadBindings(); }

EventManager::~EventManager() {
  for (auto &[fst, snd]: m_bindings) {
    delete snd;
    snd = nullptr;
  }
}
...
void EventManager::HandleEvent(sf::Event &l_event) const {
...
void EventManager::LoadBindings() {
  ...
  bindings.open("res/config/keys.cfg");
  if (!bindings.is_open()) {
